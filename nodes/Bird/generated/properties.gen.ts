...
export const birdProperties: INodeProperties[] = [
  {
    ...
    options: [
      ...
      { name: "SMS Template", value: "sms_templates", description: "Browse the SMS templates available to the workspace" },
  ...
  },
  {
    ...
    options: [
      ...
      { name: "List Templates", value: "templates_list", action: "List email templates", description: "List email templates" },
  ...
  },
  {
    ...
    options: [
      { name: "List Legs", value: "legs_list", action: "List legs" },
      { name: "Get Leg", value: "legs_get", action: "Get a leg", description: "Get a leg" },
    ],
    default: "legs_list",
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { name: "Email Batch", value: "email_batch", action: "Create a batch of email address lookups", description: "Create a batch of email address lookups" },
    ],
  ...
  },
  {
    ...
    options: [
      { name: "List", value: "list", action: "List email suppressions", description: "List email suppressions" },
      { name: "Get", value: "get", action: "Get an email suppression", description: "Get an email suppression" },
      { name: "Add", value: "add", action: "Create an email suppression", description: "Create an email suppression" },
      { name: "Remove", value: "remove", action: "Delete an email suppression", description: "Delete an email suppression" },
    ],
    default: "list",
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        placeholder: "Add Field",
        default: {},
        description: "Send a stored template instead of inline content. When set, omit `subject`, `html` and `text`, because the template supplies them. Personalize with `template.parameters`. Add `scheduled_at` to send it later.",
        options: [
          {
            displayName: "ID",
            name: "id",
    ...
    options: [
      {
        ...
        type: "string",
        default: "",
        description: "Restrict the statistics to a category or a comma-separated union of categories: `transactional` or `marketing`. Mutually exclusive with the other dimension filters; only one may be set per request.",
      },
      {
        displayName: "Compare",
        name: "compare",
      ...
      },
      {
        ...
        type: "string",
        default: "",
        description: "Restrict the statistics to a recipient mailbox domain or a comma-separated union of domains (the part of the recipient address after the `@`, for example `gmail.com`). Mutually exclusive with the other dimension filters; only one may be set per request.",
      },
      {
        ...
        type: "string",
        default: "",
        description: "Restrict the statistics to a sending domain or a comma-separated union of sending domains (the part of the From address after @). Mutually exclusive with the other dimension filters; only one may be set per request.",
      },
      {
      ...
      },
      {
        ...
        type: "string",
        default: "",
        description: "Restrict the statistics to a tag. Use `name` to match any value of a tag, or `name:value` for a specific pair (for example `campaign:spring_launch`). To combine values of one tag name, separate complete pairs with commas, such as `campaign:spring,campaign:summer`. Different tag names cannot be combined. Mutually exclusive with the other dimension filters; only one may be set per request.",
      },
      {
        displayName: "Template",
        name: "template",
        type: "string",
        default: "",
        description: "Restricts the statistics to a template or a comma-separated union of templates, identified by ID (`emt_…`) or name. This parameter is mutually exclusive with other dimension filters.",
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: "string",
        default: "",
        description: "Restrict the breakdown to this tag name. Names match case-sensitively.",
      },
      {
        displayName: "Timezone",
        name: "timezone",
  ...
  },
  {
    ...
    name: "returnAll",
    type: "boolean",
    displayOptions: { show: { resource: ["email"], operation: ["templates_list"] } },
    default: false,
    description: "Whether to return all results or only up to a given limit",
  },
  {
    ...
    options: [
      {
        ...
        default: "",
        description: "Return templates in this category",
      },
      {
        displayName: "Language",
        name: "language",
        type: "string",
        default: "",
        description: "Return templates whose published content contains this language, after the tag is canonicalized. Draft-only languages do not match.",
      },
      {
        displayName: "Q",
        name: "q",
        type: "string",
        default: "",
        description: "A case-insensitive substring search across slug, name, and description",
      },
      {
        displayName: "Scope",
        name: "scope",
        ...
        default: "",
        description: "Filter by who owns the template. Use `system` for built-in templates and `workspace` for templates your workspace created.",
      },
      {
        displayName: "Status",
        name: "status",
        ...
        default: "",
        description: "Return templates with this lifecycle status",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description: "The template's ID (`smt_…`) or slug. Built-in templates use a `bird_` slug. Write operations accept workspace templates because built-in templates are read-only.",
  },
  {
    displayName: "Message",
    name: "message_id",
  ...
  },
  {
    ...
    name: "returnAll",
    type: "boolean",
    displayOptions: { show: { resource: ["voice"], operation: ["legs_list"] } },
    default: false,
    description: "Whether to return all results or only up to a given limit",
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        default: [],
        description: "Return only legs with one of these statuses, comma-separated. In-flight and final statuses may be combined freely.",
      },
      {
        displayName: "Tag",
        name: "tag",
  ...
  },
  {
    ...
    required: true,
    default: { mode: "list", value: "" },
    displayOptions: { show: { resource: ["voice"], operation: ["legs_get"] } },
    modes: [
      {
        displayName: "From List",
        name: "list",
        ...
        typeOptions: { searchListMethod: "voiceLegsList", searchable: true },
      },
      {
        displayName: "By ID",
        name: "id",
  ...
  },
  {
    ...
    type: "string",
    required: true,
    displayOptions: { show: { resource: ["lookup"], operation: ["email_batch"] } },
    placeholder: "name@email.com",
    default: "",
    description: "Addresses to assess in submission order. Surrounding whitespace is trimmed and case is preserved. Malformed addresses receive individual assessments. Duplicates are assessed and billed at each position. The request must also fit within the 128 KiB request-body limit. Separate multiple values with a comma.",
  },
  {
    displayName: "Return All",
    name: "returnAll",
  ...
  },
  {
    ...
    options: [
      ...
      { name: "Whatsapp Delivered", value: "whatsapp.delivered" },
      { name: "Whatsapp Failed", value: "whatsapp.failed" },
      { name: "Whatsapp Group Join Request Created", value: "whatsapp.group.join_request_created" },
      { name: "Whatsapp Group Join Request Revoked", value: "whatsapp.group.join_request_revoked" },
